...
model.load_state_dict(torch.load(r'C:\Users\akash\Downloads\project-bolt-sb1-htfstm\project\captioner .pt', map_location=device))
...
# Print the model's named parameters

...
model.load_state_dict(torch.load(r'C:\Users\akash\Downloads\final project 2\project\captioner .pt', map_location=device))
...
async def generate_caption(file: UploadFile = File(...)):
    ...
    caption = model.generate(image, sequence, max_tokens=50, temperature=1.0, deterministic=False)
    caption = tokenizer.decode(caption.cpu().numpy(), skip_special_tokens=True)
